...
function findEmployeeById(employeeId) {
   ...
   function findEmployeeBySpec(employee_specialization) {
    const foundSpecEmployee = employees.find(employee => employee.specialization === employee_specialization);
    if (foundSpecEmployee) {
